...
public class SongSelectManager : MonoBehaviour {
    ...
    public TextMeshProUGUI shadowDifficultyText;
    ...
    // MetronomeForEffects - controls beat animations
    ...
    public void LoadBeatmapSongSelectInformation(int selectedDirectoryIndexPass, string beatmapDifficulty, bool hasPressedArrowKey)
    {
        ...
        shadowDifficultyText.text = beatmapDifficulty.ToUpper();
        ...
        metronomeForEffects.UpdateDifficultyAnimations(beatmapDifficulty);
        ...
        if (advancedDifficultyExist == true || extraDifficultyExist == true || easyDifficultyExist == true)
        {
            ...
            offset = Database.database.loadedOffsetMS;
            ...
            if (hasPlayedSongPreviewOnce == false || hasPressedArrowKey == true)
            {
                ...
                metronomeForEffects.GetSongData(bpm, offset);
