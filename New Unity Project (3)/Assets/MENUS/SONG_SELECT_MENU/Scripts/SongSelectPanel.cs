...
public class SongSelectPanel : MonoBehaviour
{
    ...
    private const float BEATMAP_BUTTON_OFFSET = 62;
    ...
    private void ScrollListUp()
    {
        if (Input.GetKeyDown(KeyCode.UpArrow))
        {
            ...
            if (currentSelectedBeatmapButtonIndex < currentSortedListSize - 3 && currentSelectedBeatmapButtonIndex > 2)
            {
                // Create the new Y position
                newButtonListContentPositionY = buttonListContentPositionY - BEATMAP_BUTTON_OFFSET;
                newButtonListContentPosition = new Vector3(buttonListContentPositionX, newButtonListContentPositionY, buttonListContentPositionZ);
    ...
    private void ScrollListDown()
    {
        if (Input.GetKeyDown(KeyCode.DownArrow))
        {
            ...
            if (currentSelectedBeatmapButtonIndex > 3 && currentSelectedBeatmapButtonIndex < currentSortedListSize - 2)
            {
                // Create the new Y position
                newButtonListContentPositionY = buttonListContentPositionY + BEATMAP_BUTTON_OFFSET;
                newButtonListContentPosition = new Vector3(buttonListContentPositionX, newButtonListContentPositionY, buttonListContentPositionZ);
