...
public class PlayerProfile : MonoBehaviour {
    ...
    public Material place1Material, place2Material, place3Material, place4Material, place5Material, place6Material, place7Material, place8Material,
        place9Material, place10Material, place11Material, place12Material, place13Material, place14Material, place15Material, place16Material,
        place17Material, place18Material, place19Material, place20Material;
    ...
    void Start () {
        ...
        // Initalize
        placeData = new List<string>[20];
        usernameArray = new string[20];
        playcountArray = new string[20];
        highestComboArray = new string[20];
        notesHitArray = new string[20];
        feverTimeActivationsArray = new string[20];
        highestBeatmapScoreArray = new string[20];
        oneKeyTotalScoreArray = new string[20];
        twoKeyTotalScoreArray = new string[20];
        fourKeyTotalScoreArray = new string[20];
        sixKeyTotalScoreArray = new string[20];
        overallTotalScoreArray = new string[20];
        pRankTotalArray = new string[20];
        sRankTotalArray = new string[20];
        aRankTotalArray = new string[20];
        bRankTotalArray = new string[20];
        cRankTotalArray = new string[20];
        dRankTotalArray = new string[20];
        eRankTotalArray = new string[20];
        fRankTotalArray = new string[20];
        playerImageUrlArray = new string[20];
        highestPercentageArray = new string[20];
        levelArray = new string[20];
        messageArray = new string[20];
        dateJoinedArray = new string[20];
    ...
    private void LoadProfileImage(int _leaderboardPlaceIndex)
    {
        ...
        switch (_leaderboardPlaceIndex)
        {
            ...
            case 10:
                ...
                break;
            case 11:
                profileImage.material = place11Material;
                break;
            case 12:
                profileImage.material = place12Material;
                break;
            case 13:
                profileImage.material = place13Material;
                break;
            case 14:
                profileImage.material = place14Material;
                break;
            case 15:
                profileImage.material = place15Material;
                break;
            case 16:
                profileImage.material = place16Material;
                break;
            case 17:
                profileImage.material = place17Material;
                break;
            case 18:
                profileImage.material = place18Material;
                break;
            case 19:
                profileImage.material = place19Material;
                break;
            case 20:
                profileImage.material = place20Material;
                break;
